          ...
          <div className="xl:col-span-2 md:pr-8">
            ...
            <div className="text-lg leading-8 text-gray-600 dark:text-gray-400">
              <h1 className="text-neutral-900 dark:text-neutral-200">
                I'm <span className="font-medium">Thanh Hai Huynh</span> - an open-minded{' '}
                <span className="font-medium">Software Engineer</span> in{' '}
                <span className="font-medium hidden">Long An, VN</span>
              ...
              <p className="mt-4 mb-8">
                I started my coding journey in 2019 with ReactJS
                <br />
                I had my first job as Frontend Developer.
                <br />
                I'm in love with the JS ecosystem, web dev.
                <br />
