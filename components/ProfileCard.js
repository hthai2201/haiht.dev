...
const ProfileInfo = () => (
  <div className="hidden xl:block xl:px-6 py-4">
    <h1 className="text-xl font-semibold text-gray-800 dark:text-white">Thanh Hai (Luke) Huynh</h1>
    <p className="py-2 text-gray-700 dark:text-gray-400">Learner | Developer</p>
    <div className="space-y-4 mt-4 mb-2">
      <div className="flex items-center text-gray-700 dark:text-gray-200">
        ...
        <p className="px-2">Frontend Developer - ReactJS</p>
      </div>
      <div className="flex items-center text-gray-700 dark:text-gray-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
